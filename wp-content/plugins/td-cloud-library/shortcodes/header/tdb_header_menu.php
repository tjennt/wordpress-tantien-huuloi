            ...
            <script>
                ...
                jQuery().ready(function () {
                    ...
                    <?php if( $this->get_att('mm_align_screen') == 'yes' ) { ?>
                        tdbMenu.megaMenuFull( tdbMenuItem, <?php if (tdc_state::is_live_editor_ajax() || tdc_state::is_live_editor_iframe() ) echo 'true'; else echo 'false'; ?> );
                    <?php } ?>

                    <?php if( $this->get_att('mm_align_screen') == '' || $this->get_att('mm_align_screen') == 'parent' ) { ; ?>
                        tdbMenu.megaMenuParentPos( tdbMenuItem, <?php if (tdc_state::is_live_editor_ajax() || tdc_state::is_live_editor_iframe() ) echo 'true'; else echo 'false'; ?> );
                    <?php } ?>
