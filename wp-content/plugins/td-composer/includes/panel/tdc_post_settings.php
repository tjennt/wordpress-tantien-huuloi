    ...
    <?php if ( current_user_can("switch_themes") ) { ?>
        ...
        <div class="td-box-row td-box-autoload-status">
            <div class="td-box-description">
                <span class="td-box-title" title="Enable or disable the articles auto loading on scrolling feature on article pages.">Auto Loading Status</span>
            </div>
        ...
        <div class="td-box-row td-box-autoload-count">
            <div class="td-box-description">
                <span class="td-box-title" title="Number of articles to load on scroll. Leave empty for no limit.">Number of Auto Loaded Articles</span>
            </div>
            <div class="td-box-control-full">
                <?php
