...
new tdcIFrameData.TdcTopCollection;var a=tdcIFrameData._getPostOriginalContentJSON();a.length||(window.tdcPostSettings.postContent=window.tdcPostSettings.postContent.length&&"header"!==window.tdcPostSettings.tdbTemplateType?tdcUtil.b64EncodeUnicode("[tdc_zone]"+tdcUtil.b64DecodeUnicode(window.tdcPostSettings.postContent)+"[/tdc_zone]"):tdcUtil.b64EncodeUnicode("[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]"),a=tdcIFrameData._getPostOriginalContentJSON(!0));var c={};c.tdc_content=a;
a=tdcState.getHeaderTemplateContent();if(""!==a){a=JSON.parse(tdcUtil.b64DecodeUnicode(a));for(var e in a)c[e]=tdcIFrameData._getHeaderOriginalContentJSON(a[e])}var d=tdcShortcodeParser.parse(0,"[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]");["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky","tdc_content"].forEach(function(a){if(b.isUndefined(c[a])||""===c[a]||"object"===typeof c[a]&&!c[a].length)c[a]=[{child:[d[0].child[0]],index:0,content:"[tdc_zone][vc_row][vc_column][/vc_column][/vc_row][/tdc_zone]",
shortcode:{tag:"tdc_zone",type:"closed",attrs:{named:{}},content:"[vc_row][vc_column][/vc_column][/vc_row]"}}]});for(var l in c)if(c.hasOwnProperty(l)&&!tdcIFrameData._initComponentData(l,c[l]))return;return!0}},_initComponentData:function(a,c,d){if(!b.isUndefined(d)&&!1!==d||!tdcIFrameData._isInitialized){if(c.length){var g={};b.each(c,function(c,b,d){tdcIFrameData._getData(e,c,g,e,a)});b.isEmpty(g)||(tdcDebug.log(g),new tdcNotice.notice("Errors happened during _initStructureData() -> _getData()!",
...
(g="Not zones as the first elements!");!b.isUndefined(a)&&parseInt(a.get("level"),10)>=parseInt(f,10)&&(g="Elements does not respect the shortcode levels! ParentModel (cid: "+a.cid+" ) level: "+a.get("level")+" - element level : "+f);!b.isUndefined(a)&&1<parseInt(f,10)-parseInt(a.get("level"),10)&&3!==parseInt(a.get("level"),10)&&5!==parseInt(f,10)&&(g="Elements respect the shortcode levels, but the difference higher than 1 is not allowed here!");b.isUndefined(g)||(e[b.keys(e).length]={element:c,
...
new tdcNotice.notice("_getSourceCol Error: Tne column model not in structure data!",!0,!1),a=tdcIFrameData._parseModelWidthAttrs(a)},getShortcodeFromData:function(a){a.getShortcode="";var c=tdcIFrameData.getFirstModelByZoneType("tdc_content");tdcIFrameData._checkModelData(c,a)},getHeaderShortcodeFromData:function(){var a={};["tdc_header_desktop","tdc_header_desktop_sticky","tdc_header_mobile","tdc_header_mobile_sticky"].forEach(function(c){var d={error:e,getShortcode:""},g=tdcIFrameData.getFirstModelByZoneType(c);
tdcIFrameData._checkModelData(g,d);b.isUndefined(d.error)?b.isUndefined(d.getShortcode)?delete a[c]:a[c]=d.getShortcode:new tdcNotice.notice(d.errors,!0,!1)});if(!b.isEmpty(a))return a},bindViewsModelsWrappers:function(a,c,e,d){if(b.isEmpty(a)&&(b.isUndefined(d)&&(d=0),!b.isUndefined(c))){switch(d){case 0:e=e.find(".tdc-zone");if(c.models.length!==e.length){a[b.keys(a).length]={collection:c,jqDOMElements:e,info:"Error at zones: "+c.models.length+"(models) : "+e.length+"(dom)"};return}d++;b.each(e,
function(c,b,e){b=f(c);e=b.data("type");e=tdcIFrameData.getFirstModelByZoneType(e);b.data("model_id",e.cid);e.set("blockUid",b.attr("id"));e.set("html",c.innerHTML);new tdcIFrameData.TdcLiveView({model:e,el:c});e.has("childCollection")&&tdcIFrameData.bindViewsModelsWrappers(a,e.get("childCollection"),b,d)});d--;return;case 1:var g=e.find(".tdc-row");if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Error at rows: "+c.models.length+"(models) : "+g.length+"(dom)"};
return}break;case 2:g=e.find(".tdc-columns:first").children(".tdc-column");if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at columns: "+c.models.length+"(models) : "+g.length+"(dom)",level:d};return}break;case 3:g=e.find(".tdc-elements:first").children(".tdc-element, .tdc-element-inner-row");if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at columns elements: "+c.models.length+"(models) : "+g.length+"(dom)",
level:d};return}break;case 4:g=e.find(".tdc-inner-columns:first").children(".tdc-inner-column");if(c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at inner columns: "+c.models.length+"(models) : "+g.length+"(dom)",level:d};return}break;case 5:if(g=e.find(".tdc-elements:first").children(".tdc-element"),c.models.length!==g.length){a[b.keys(a).length]={collection:c,jqDOMElements:g,info:"Errors at elements: "+c.models.length+"(models) : "+g.length+"(dom)",level:d};
return}}d++;b.each(g,function(e,g,m){g=c.models[g];m=f(e);m.data("model_id",g.cid);g.set("html",e.innerHTML,{silent:!0});if(5===g.get("level")){var k=m.data("td-block-uid");if(b.isUndefined(k)){var l=m.find(".td_block_inner, .tdb-block-inner, .td-post-sharing");l.length&&(k=l.attr("id"))}}else 3===g.get("level")?(l=m.find(".tdc-inner-row"),l.length&&(k=l.attr("id"))):1===g.get("level")&&(k=m.attr("id"));g.set("blockUid",k);new tdcIFrameData.TdcLiveView({model:g,el:e});!m.hasClass("tdc-element")&&
g.has("childCollection")&&0<b.size(g.get("childCollection"))&&tdcIFrameData.bindViewsModelsWrappers(a,g.get("childCollection"),m,d)});d--}},changeRowModel:function(a,c,e){var d=a.get("childCollection");if("11"===c&&("23_13"===e||"13_23"===e||"13_13_13"===e)){e=e.split("_");var m=e[0].charAt(0)+"/"+e[0].charAt(1),k=d.at(0),h=k.get("attrs");b.isUndefined(h)?k.set("attrs",{width:m}):(h=b.clone(h),h.width=m,k.set("attrs",h));d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[1].charAt(0)+
"/"+e[1].charAt(1)},type:"closed",level:1,parentModel:a}));3===e.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a}));tdcIFrameData.changeColumnModel(k,c,e[0])}else if(("23_13"===c||"13_23"===c||"13_13_13"===c)&&"11"===e){c=c.split("_");k=d.at(0);h=k.get("attrs");var f=k.get("childCollection"),p=d.at(1),q=p.get("childCollection");b.isUndefined(h)||(h=b.clone(h),delete h.width,k.set("attrs",h));b.isUndefined(f)&&
(f=new tdcIFrameData.TdcCollection,k.set("childCollection",f));!b.isUndefined(q)&&q.length&&b.each(q.models,function(a,c,b){a.set("parentModel",k);f.add(a)});3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",k);f.add(a)}),tdcIFrameData.removeModel(a));tdcIFrameData.removeModel(p);tdcIFrameData.changeColumnModel(k,c[0],e)}else if(!("23_13"!==c&&"13_23"!==c&&"13_13_13"!==c||"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)){c=
c.split("_");e=e.split("_");m=e[0].charAt(0)+"/"+e[0].charAt(1);var t=e[1].charAt(0)+"/"+e[1].charAt(1);k=d.at(0);h=k.get("attrs");p=d.at(1);var v=p.get("attrs");q=p.get("childCollection");3===e.length?d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column",attrs:{width:e[2].charAt(0)+"/"+e[2].charAt(1)},type:"closed",level:1,parentModel:a})):3===c.length&&(a=d.at(2),d=a.get("childCollection"),!b.isUndefined(d)&&d.length&&(b.isUndefined(q)&&(q=new tdcIFrameData.TdcCollection,p.set("childCollection",
q)),b.each(d.models,function(a,c,b){a.set("parentModel",p);q.add(a)})),tdcIFrameData.removeModel(a));h=b.clone(h);h.width=m;k.set("attrs",h);c[0]!==e[0]&&tdcIFrameData.changeColumnModel(k,c[0],e[0]);m=b.clone(v);m.width=t;p.set("attrs",m);c[1]!==e[1]&&tdcIFrameData.changeColumnModel(p,c[1],e[1])}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)},changeFluidStructureModel:function(a,c,e){var d=a.get("childCollection"),m=a.get("tag"),k="vc_column";c=c.split("_");var f=e.split("_");if("vc_row"===m||
"vc_row_inner"===m){"vc_row_inner"===m&&(k="vc_column_inner");if(f.length>c.length)for(m=0;m<f.length;m++){e="";for(var n=0;n<f[m].length;n++)e+=f[m].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));if(m<c.length){var p=d.at(m);n=p.get("attrs");var q=b.clone(n);q.width=e;p.set("attrs",q)}else d.add(new tdcIFrameData.TdcModel({content:"",tag:k,attrs:{width:e},type:"closed",level:1,parentModel:a}))}else for(m=0;m<c.length;m++)if(m<f.length){p=d.at(m);n=p.get("attrs");q=b.clone(n);e="";for(n=0;n<
f[m].length;n++)e+=f[m].charAt(n)+"/";""!==e&&(e=e.substring(0,e.length-1));q.width=e;p.set("attrs",q);var t=p}else{p=d.at(f.length);a=p.get("childCollection");var v=t.get("childCollection");b.isUndefined(v)&&(v=new tdcIFrameData.TdcCollection,t.set("childCollection",v));b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",t);v.add(a)});tdcIFrameData.removeModel(p)}tdcDebug.log(tdcIFrameData.tdcTopCollection.models)}},changeColumnModel:function(a,c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||
b.isUndefined(e))){var d=a.get("childCollection");if(!b.isUndefined(d)&&d.length){var m=a.get("attrs");!b.isUndefined(m)&&b.has(m,"width");b.each(d.models,function(d,g,m){if("vc_row_inner"===d.get("tag")&&(d=d.get("childCollection"),!b.isUndefined(d)&&d.length)){var l="";b.each(d.models,function(a,c,e){a=a.get("attrs");!b.isUndefined(a)&&b.isObject(a)&&b.has(a,"width")&&(l=c===e.length-1?l+a.width:l+(a.width+"_"))});l=l.replace(/\//g,"");"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l&&(l="");
if("11"===c)if("23"===e)if("23_13"===l){var f=d.at(0),k=d.at(1);m=f.get("attrs");g=k.get("attrs");m=b.clone(m);g=b.clone(g);m.width="1/2";g.width="1/2";f.set("attrs",m);k.set("attrs",g)}else if("13_23"===l)f=d.at(0),k=d.at(1),m=f.get("attrs"),g=k.get("attrs"),m=b.clone(m),g=b.clone(g),m.width="1/2",g.width="1/2",f.set("attrs",m),k.set("attrs",g);else if("13_13_13"===l){f=d.at(0);k=d.at(1);d=d.at(2);m=f.get("attrs");g=k.get("attrs");var h=d.get("attrs");m=b.clone(m);g=b.clone(g);b.clone(h);m.width=
"1/2";g.width="1/2";f.set("attrs",m);k.set("attrs",g);g=d.get("childCollection");if(!b.isUndefined(g)&&g.length){var n=k.get("childCollection");b.isUndefined(n)&&(n=new tdcIFrameData.TdcCollection,k.set("childCollection",n));b.each(g.models,function(a,c,b){n.add(a);a.set("parentModel",k)})}tdcIFrameData.removeModel(d)}else{if(d.models.length){f=d.at(0);m=f.get("attrs");m=b.clone(m);var r=f.get("childCollection");delete m.width;f.set("attrs",m);b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,
f.set("childCollection",r));var w=0;for(b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}}else{if("13"===e&&d.models.length)for(f=d.at(0),m=f.get("attrs"),m=b.clone(m),r=f.get("childCollection"),delete m.width,f.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==
c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("23"===c)if("11"===e)if("12_12"===l)f=d.at(0),k=d.at(1),m=f.get("attrs"),g=k.get("attrs"),m=b.clone(m),g=b.clone(g),m.width="1/3",g.width="1/3",f.set("attrs",m),k.set("attrs",g),g=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:"1/3"},type:"closed",level:3,parentModel:a}),d.add(g);else{if(d.models.length)for(f=
d.at(0),m=f.get("attrs"),m=b.clone(m),r=f.get("childCollection"),delete m.width,f.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else{if("13"===e&&d.models.length)for(f=d.at(0),m=f.get("attrs"),m=b.clone(m),r=f.get("childCollection"),delete m.width,f.set("attrs",
m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else if("13"===c)if("11"===e)if(""===l||"12_12"!==l&&"23_13"!==l&&"13_23"!==l&&"13_13_13"!==l){if(d.models.length)for(f=d.at(0),m=f.get("attrs"),m=b.clone(m),r=f.get("childCollection"),delete m.width,f.set("attrs",
m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),w--}else"12_12"===l&&d.models.length&&(f=d.at(0),k=d.at(1),m=f.get("attrs"),g=k.get("attrs"),m.width="1/3",g.width="1/3",f.set("attrs",m),k.set("attrs",g),d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",
attrs:{width:"1/3"},type:"closed",level:1,parentModel:a})));else if("23"===e&&(""===l||"12_12"!==l)&&d.models.length)for(f=d.at(0),m=f.get("attrs"),m=b.clone(m),r=f.get("childCollection"),delete m.width,f.set("attrs",m),b.isUndefined(r)&&(r=new tdcIFrameData.TdcCollection,f.set("childCollection",r)),w=0,b.each(d.models,function(a,c,e){0!==c&&(w=c,a=a.get("childCollection"),b.isUndefined(a)||b.each(a.models,function(a,c,b){a.set("parentModel",f);r.add(a)}))});0<w;)tdcIFrameData.removeModel(d.at(w)),
w--}})}}},changeInnerRowModel:function(a,c,e){if(!(b.isUndefined(a)||b.isUndefined(c)||b.isUndefined(e))){var d=a.get("childCollection");if("11"!==c||"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)if("12_12"!==c&&"23_13"!==c&&"13_23"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e&&"13_13_13"!==e)"13_13_13"!==c||"11"!==e&&"12_12"!==e&&"23_13"!==e&&"13_23"!==e?tdcIFrameData.changeFluidStructureModel(a,c,e):("11"===e?(q=d.at(0),t=q.get("attrs"),m=q.get("childCollection"),h=d.at(1),f=h.get("childCollection"),
a=d.at(2),d=a.get("childCollection"),b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t)),b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,q.set("childCollection",m)),!b.isUndefined(f)&&f.length&&b.each(f.models,function(a,c,b){a.set("parentModel",q);m.add(a)}),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",q);m.add(a)}),tdcIFrameData.removeModel(h)):(n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1),c=n[1].charAt(0)+"/"+n[1].charAt(1),q=d.at(0),
t=q.get("attrs"),h=d.at(1),e=h.get("attrs"),f=h.get("childCollection"),a=d.at(2),d=a.get("childCollection"),t=b.clone(t),t.width=p,q.set("attrs",t),e=b.clone(e),e.width=c,h.set("attrs",e),b.isUndefined(f)&&(f=new tdcIFrameData.TdcCollection,h.set("childCollection",f)),!b.isUndefined(d)&&d.length&&b.each(d.models,function(a,c,b){a.set("parentModel",h);f.add(a)})),tdcIFrameData.removeModel(a));else if("11"===e){q=d.at(0);t=q.get("attrs");var m=q.get("childCollection");h=d.at(1);var f=h.get("childCollection");
b.isUndefined(t)||(t=b.clone(t),delete t.width,q.set("attrs",t));b.isUndefined(m)&&(m=new tdcIFrameData.TdcCollection,q.set("childCollection",m));!b.isUndefined(f)&&f.length&&b.each(f.models,function(a,c,b){a.set("parentModel",q);m.add(a)});tdcIFrameData.removeModel(h)}else n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1),c=n[1].charAt(0)+"/"+n[1].charAt(1),q=d.at(0),t=q.get("attrs"),h=d.at(1),e=h.get("attrs"),t=b.clone(t),t.width=p,q.set("attrs",t),e=b.clone(e),e.width=c,h.set("attrs",e),3===n.length&&
d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:n[2].charAt(0)+"/"+n[2].charAt(1)},type:"closed",level:3,parentModel:a}));else{var h=new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",type:"closed",level:3,parentModel:a}),n=e.split("_"),p=n[0].charAt(0)+"/"+n[0].charAt(1);c=n[1].charAt(0)+"/"+n[1].charAt(1);var q=d.at(0),t=q.get("attrs");b.isUndefined(t)?q.set("attrs",{width:p}):(t=b.clone(t),t.width=p,q.set("attrs",t));h.set("attrs",{width:c});d.add(h);3===
n.length&&d.add(new tdcIFrameData.TdcModel({content:"",tag:"vc_column_inner",attrs:{width:n[2].charAt(0)+"/"+n[2].charAt(1)},type:"closed",level:3,parentModel:a}))}}},getChildCollectionWidths:function(a){if(!b.isUndefined(a)){var c;b.map(a.models,function(a,e){var d=a.get("attrs");b.has(d,"width")&&(c=b.isUndefined(c)?d.width.replace("/",""):c+("_"+d.width.replace("/","")))});return c}}}})(jQuery,Backbone,_);var tdcAdminIFrameUI;
...
a.find(".tdc-content-wrap").prepend('<div class="tdc-zone" '+c+'><div class="tdc-row"><div class="vc_row wpb_row td-pb-row"><div class="tdc-column"><div class="td-pb-span12 wpb_column vc_column_container"><div class="wpb_wrapper"></div></div></div></div></div></div>')}},init:function(){window.addWrappers=function(a,c,b){a=a.find(c);a.find(".tdc-zone").length||a.find(".tdc-row").wrapAll('<div class="tdc-zone" data-type="tdc_content"></div>');a.find(".tdc-zone").data("type",b);a.find(".tdc-row").each(function(a,
...
"undefined"!==typeof f&&n.attr("placeholder",f),f=n.data("param_name"),delete d[f],n=n.attr("name"),tdcSidebarPanel.deleteResponsiveValues(n))}}c.set("attrs",d);tdcSidebarController.onUpdate(c,f,"","")}})});d.on("click",".tdc-sidebar-font-save",function(b){b=jQuery(this);var e=b.data("model_id");e=tdcIFrameData.getModel(e).get("attrs");var a=b.data("param_name").replace("font_settings",""),c="font_family font_size font_line_height font_style font_weight font_transform".split(" "),d={};_.each(e,function(b,
e,f){if(0===e.indexOf(a))for(f=0;f<c.length;f++)if(0<e.indexOf(c[f])){d[c[f]]=b;break}});_.isEmpty(d)||tdConfirm.modal({caption:"Saving Font Settings",htmlInfoContent:function(){setTimeout(function(){jQuery("#TB_ajaxContent").find("input").focus()},100);return'<label>Font Name: </label><input type="text" autofocus><div class="info"></div>'},textYes:"Save",textNo:"Cancel",callbackYes:function(){var a=jQuery("#TB_ajaxContent"),c=a.find(".info");a=a.find("input").val().trim();if(""===a)c.html("Please enter a font name");
else{if("undefined"===typeof window.tdcAdminSettings.tdcSavings||""===window.tdcAdminSettings.tdcSavings)window.tdcAdminSettings.tdcSavings={};"undefined"===typeof window.tdcAdminSettings.tdcSavings.fonts&&(window.tdcAdminSettings.tdcSavings.fonts=[]);-1===_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:a})?(c.html("Saving..."),window.tdcAdminSettings.tdcSavings.fonts.push({name:a,value:window.btoa(JSON.stringify(d))}),tdcUtil.updateTdcSavings(window,function(){jQuery("#TB_ajaxContent").find(".info").html("Font has been saved!");
setTimeout(function(){tb_remove()},500)})):c.html("Font name already exists! Choose another one")}}})});d.on("click",".tdc-sidebar-font-load",function(){var b=jQuery(this),e=b.closest(".tdc-property-wrap"),a=b.data("model_id"),c=b.data("param_name");if(""!==window.tdcAdminSettings.tdcSavings&&("undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts||"undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts)){var d=jQuery("#tdc-font-list");d.length||(d=tdcSidebar.buildFontList(a,c));
d.html("");"undefined"!==typeof window.tdcAdminSettings.tdcSavings.fonts&&(jQuery('<div class="tdc-font-list-header"><span>Saved fonts</span></div>').appendTo(d),_.map(window.tdcAdminSettings.tdcSavings.fonts,function(b){jQuery('<div class="tdc-font-settings" data-value="'+b.value+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+b.name+'</span><span class="tdc-font-delete"></span></div>').appendTo(d)}));if("undefined"!==typeof window.tdcAdminSettings.tdcSavings.recentFonts){jQuery('<div class="tdc-font-list-header"><span>Recent fonts</span></div>').appendTo(d);
b=_.invert(window.tdcAdminSettings.mappedFontFamily);for(var g=window.tdcAdminSettings.tdcSavings.recentFonts.length;0<g;g--){var f=window.tdcAdminSettings.tdcSavings.recentFonts[g],k=b[f];_.isUndefined(k)||jQuery('<div class="tdc-recent-font-settings" data-value="'+f+'" data-model_id="'+a+'" data-param_name="'+c+'"><span class="tdc-font-name">'+k+'</span><span class="tdc-recent-font-delete"></span></div>').appendTo(d)}}e.after(d);d.toggle()}});d.on("click",".tdc-font-delete",function(b){b.stopImmediatePropagation();
var e=jQuery(this).closest(".tdc-font-settings");b=e.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.fonts,{name:b});window.tdcAdminSettings.tdcSavings.fonts.splice(b,1);tdcUtil.updateTdcSavings(this,function(){e.remove()})});d.on("click",".tdc-recent-font-delete",function(b){b.stopImmediatePropagation();var e=jQuery(this).closest(".tdc-recent-font-settings");b=e.data("name");b=_.findIndex(window.tdcAdminSettings.tdcSavings.recentFonts,{name:b});window.tdcAdminSettings.tdcSavings.recentFonts.splice(b,
1);tdcUtil.updateTdcSavings(this,function(){e.remove()})});d.on("click",".tdc-font-settings",function(){var b=jQuery(this),e=b.data("value");e=JSON.parse(window.atob(e));var a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs"),d=b.data("param_name").replace("font_settings",""),g="font_family font_size font_line_height font_style font_weight font_transform".split(" ");_.each(e,function(a,b,e){-1!==_.indexOf(g,b)&&(c[d+b]=a)});a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)});
d.on("click",".tdc-recent-font-settings",function(){var b=jQuery(this),e=b.data("value"),a=b.data("model_id");a=tdcIFrameData.getModel(a);var c=a.get("attrs");b=b.data("param_name").replace("font_settings","");c[b+"font_family"]=e;a.set({attrs:c,rebindToPanel:!0});tdcSidebarController.onUpdate(a)})},getCurrentStyleSettings:function(d,b){if(_.isUndefined(b)){var e=jQuery(d.currentTarget).data("model_id");b=tdcIFrameData.getModel(e);e={error:f};_.isUndefined(b)||tdcIFrameData._checkModelData(b,e)}var a=
b.get("tag");e=b.get("attrs");e=_.clone(e);if(!_.isUndefined(e)){var c={},m={};for(g in e)0===g.indexOf("tds_")&&(c[g]=e[g]);var g=window.tdcAdminSettings.mappedShortcodes[a].params;for(a=0;a<g.length;a++){var l=!1,k=g[a];if(0===k.param_name.indexOf("tds_")){for(var h in c)if(k.param_name===h){m[h]=c[h];l=!0;break}l||(m[k.param_name]="")}}for(h in c)switch(g=h.split("-"),g.length){case 2:if(!_.has(m,h)){c=g[0];g=!1;for(var n in m)if(c===m[n]&&1===n.split("-").length){g=!0;break}if(!g){var p;for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],
c)){var q=p;break}_.has(m,q)&&""===m[q]&&window.tdcAdminSettings.globalStyle[q]===c&&(g=!0)}g||delete e[h]}break;case 3:c=g[0];a=g[2];for(p in window.tdcAdminSettings.settingsStyle)if(_.has(window.tdcAdminSettings.settingsStyle[p],c)){q=p;break}g=!1;for(n in m)if(c===m[n]&&n===q+"-"+a){g=!0;break}g||_.has(m,q+"-"+a)&&""===m[q+"-"+a]&&window.tdcAdminSettings.globalStyle[q]===c&&(g=!0);g||delete e[h]}return e}},showHideTdcPalette:function(d){d=jQuery("#tdc-palette");var b=jQuery(this).closest(".tdc-property-wrap");
d.length||tdcSidebar.buildPalette();b.next("#tdc-palette").length?(d.toggle(),tdcSidebarPanel.saveTdcPalette()):(tdcSidebarPanel.saveTdcPalette(),b.after(d),d.show(),tdcSidebarPanel.openTdcPalette())},saveTdcPalette:function(){var d=jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),d=d.find("input.wp-color-picker"),d.tdPaletteColorPicker("open_palette",b),d.tdPaletteColorPicker("save_color"))},openTdcPalette:function(){var d=
jQuery("#tdc-palette"),b=d.prev(".tdc-property-wrap");d.length||tdcSidebar.buildPalette();b.length&&(b=b.find("input").val(),d.find("input.wp-color-picker").tdPaletteColorPicker("open_palette",b))},tdcIconWrapHandler:function(d){var b=jQuery(this),e=jQuery("#tdc-icon-selector");e.length||(e=tdcSidebar.buildIconSelector());var a=b.closest(".tdc-property-wrap");d=e.find(".tdc-icon-selector-filter");var c=e.find(".tdc-icon-selector-lib"),f=e.find(".tdc-icon-selector-content");c.val("");d.val("");f.children().each(function(){jQuery(this).show()});
e.data("model_id",b.data("model_id"));e.data("param_name",b.data("param_name"));e.show();a.after(e);b=e.data("param_name");e=tdcIFrameData.getModel(e.data("model_id")).get("attrs");var g="";_.has(e,b)&&(g=e[b].trim());d.focus();f.find("span").each(function(){var a=jQuery(this),b=a.data("font_class");if(g===b){for(a.addClass("selected");!a.prev(".tdc-font-separator").length;)a=a.prev();a=a.prev(".tdc-font-separator").data("font_id");c.val(a);c.trigger("change")}else a.removeClass("selected")})},tdcIconRemoveHandler:function(d){var b=
...
jQuery(".media-menu .media-menu-item:nth-of-type(3)").addClass("hidden");jQuery(".media-menu .media-menu-item:nth-of-type(4)").addClass("hidden");window.send_to_editor=function(e){var a=jQuery("img",e).attr("src"),c="",d="",g="";"undefined"===typeof a?(a=jQuery(e).attr("src"),c=jQuery(e).attr("class"),d=jQuery(e).attr("height"),g=jQuery(e).attr("width")):(c=jQuery("img",e).attr("class"),d=jQuery("img",e).attr("height"),g=jQuery("img",e).attr("width"));jQuery.ajax({timeout:1E4,type:"POST",url:tdcUtil.getRestEndPoint("td-composer/get_image_id",
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_class:c,action:"tdc_ajax_get_image_id"}}).done(function(c,e,f){"success"===e&&(_.isObject(c)&&_.has(c,"errors")?new tdcNotice.notice(c.errors,!0,!1):(b.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button"),b.attr("style","background-image: url( '"+a+"') "),b.data("image_link",a),b.data("image_id",c.image_id),b.data("image_height",
d),b.data("image_width",g),b.removeClass("tdc-no-image-selected"),window.send_to_editor=window.original_send_to_editor,window.tb_remove(),e="",f=b.data("model_id"),f=tdcIFrameData.getModel(f),b.hasClass("tdc-no-image-selected")||(e=c.image_id.toString()),c=f.get("attrs"),c.media_size_image_height=d,c.media_size_image_width=g,f.set("attrs",c),tdcSidebarController.onUpdate(f,b.data("param_name"),"",e)))}).fail(function(a,c,b){})};return!1},tdcImageRemoveHandler:function(d){var b=jQuery(d.currentTarget);
...
jQuery(".tdc-tab-content-wrap .tdc-property-responsive").each(function(){var a=jQuery(this),c=a.find("[data-responsive]"),b=c.attr("name"),e=c.data("responsive");try{var d=window.atob(e);window.tdcResponsiveValues[b]=JSON.parse(d)}catch(z){e={},a.hasClass("tdc-property-textfield-responsive")?""!==c.val()&&(e.all=c.val()):a.hasClass("tdc-property-dropdown-responsive")?c.find("option:first").val()!==c.val()&&(e.all=c.val()):a.hasClass("tdc-property-checkbox-responsive")?c.is(":checked")&&(e.all=c.val()):
a.hasClass("tdc-property-range-responsive")?e.all=c.data("value"):a.hasClass("tdc-property-range_multiple-responsive")&&(e.all=c.data("range_value")+c.data("range_unit")),window.tdcResponsiveValues[b]=e}tdcSidebarPanel.setViewportCurrentResponsiveValue(c)}))});tdcSidebarPanel._hook.addAction("panel_rendered",function(){jQuery(".tdc-tab-content-wrap").find('select[name$="font_family"]').change(function(a){a=jQuery(this).val();""===window.tdcAdminSettings.tdcSavings&&(window.tdcAdminSettings.tdcSavings=
...
b);case "shadow_header":return tdcSidebarPanel.addShadowHeader(d,b);case "shadow_title":return tdcSidebarPanel.addShadowTitle(d,b);case "clearfix":return tdcSidebarPanel.addClearfix(d,b);case "tdc_hidden_field":return"";default:return d.param_name+" - "+d.type+"<br>"}},_deletePanel:function(){tdcSidebarPanel._hook._hooks=[];tdcSidebarPanel._currentBoundModel=f;tdcSidebarPanel.saveTdcPalette();jQuery(".tdc-breadcrumbs").hide();jQuery(".tdc-inspector .tdc-current-element-head").empty();jQuery(".tdc-inspector .tdc-tabs-wrapper").empty();
...
case "Ajax filter":return"Ajax"}return d},clearPanel:function(){tdcSidebarPanel._deletePanel()},blurInputPanel:function(){jQuery("body").find("input").blur()},_addPresetValuesSelector:function(d,b){var e='<div class="tdc-preset-values tdc-sidebar-horizontal-separator"><i class="tdc-font-fa tdc-font-fa-cube"></i>Pre-made style presets<i class="tdc-font-fa tdc-font-fa-angle-right"></i></div>'+('<ul class="tdc-preset-values-list" data-model_id="'+b.cid+'">');for(var a=1;a<d.length;a++){var c="";_.isUndefined(d[a].tdc_preset_individual)||
(c='data-individual="1"');var f="";_.isUndefined(d[a].tdc_preset_class)||(f=' class="'+d[a].tdc_preset_class+'"');e+="<li "+c+" "+f+' data-values="'+window.btoa(JSON.stringify(d[a]))+'">'+d[a].tdc_preset_name+"</li>"}e+="</ul>";tdcSidebarPanel._hook.hasCallback("panel_rendered",tdcSidebarPanel.callbackPresets)||tdcSidebarPanel._hook.addAction("panel_rendered",tdcSidebarPanel.callbackPresets);return e},callbackPresets:function(){jQuery(".tdc-preset-values").click(function(){jQuery(this).next(".tdc-preset-values-list").toggle()});
...
"uuid="+tdcJobManager._getUniqueID()),beforeSend:function(a){a.setRequestHeader("X-WP-Nonce",window.tdcAdminSettings.wpRestNonce)},dataType:"json",data:{image_id:f,action:"tdc_ajax_get_image_url"}}).done(function(a,b,e){"success"===b&&(_.isObject(a)&&_.has(a,"errors")?new tdcNotice.notice(a.errors,!0,!1):(c.attr("style","background-image: url('"+a.image_url+"')").removeClass("tdc-no-image-selected"),c.data("image_link",a.image_url),c.data("image_id",f),c.closest(".tdc-property").find(".tdc-image-remove").removeClass("tdc-hidden-button")))}).fail(function(a,
...
tdcWindowFrame.setWindowFrame(tdcSidebar.$_tdcZone)});tdcSidebar.$_tdcZone.on("click",".tdc-zone-icon",function(e){e=f(this).parent();var a=e.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");e.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===a?(tdcIFrameData.activateZone(a,!0,!0),e.addClass("tdc-zone-sticky-active"),e.removeClass("tdc-zone-sticky-inactive")):tdcIFrameData.activateZone(a,b,!0)}).on("click",".tdc-zone-sticky-info",
function(e){e=f(this).parent();var a=e.data("type");tdcSidebar.$_tdcZone.find(".tdc-zone").removeClass("tdc-zone-active");e.addClass("tdc-zone-active");"tdc_header_desktop_sticky"===a||"tdc_header_mobile_sticky"===a?(e.hasClass("tdc-zone-sticky-inactive")?tdcIFrameData.activateZone(a,!0,!0):tdcIFrameData.activateZone(a,!1),e.toggleClass("tdc-zone-sticky-active"),e.toggleClass("tdc-zone-sticky-inactive")):tdcIFrameData.activateZone(a,b,!0)}).on("change",".tdc-header-template-list",function(b){b=f(this);
...
tdcSidebar.$_liveIframeWrapper.hasClass("tdc-live-iframe-wrapper-inline")||tdcSidebar.$_liveIframeWrapper.addClass("tdc-live-iframe-wrapper-full");tdcMain.resetSidebarHidden()});tdcSidebar.$_sidebarMenu.click(function(b){f(this).toggleClass("tdc-window-open");f(".tdc-sidebar-modal").each(function(a,c){var b=f(c),e=b.data("button_class");b.hasClass("tdc-sidebar-modal-menu")?b.toggleClass("tdc-modal-open"):(b.removeClass("tdc-modal-open"),"undefined"!==typeof e&&""!==e&&(b=f("."+e),b.length&&b.removeClass("tdc-window-open")))})});
tdcSidebar.$_sidebarSearch.keyup(function(b){var a=f(this);f(".tdc-sidebar-element").each(function(c,b){var e=f(b);-1===e.find(".tdc-element-id").html().toLowerCase().indexOf(a.val().trim().toLowerCase())?e.hide():e.show()});f(".tdc-sidebar-separator").each(function(a,b){var c=f(b);c.nextUntil(".tdc-sidebar-separator").is(":visible")?c.show():c.hide()})});tdcSidebar.$_sidebar.on("mouseenter",function(){tdcSidebar.mouseOverSidebar=!0}).on("mouseleave",function(){tdcSidebar.mouseOverSidebar=!1});f("body").css("overflow",
...
tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible")});tdcSidebar.$_currentElementSiblings.mouseleave(function(a){tdcSidebar.$_currentElementSiblings.removeClass("tdc-current-element-siblings-visible")});tdcSidebar.$_inspector.show()},closeModals:function(){f(".tdc-sidebar-modal").each(function(b,a){var c=f(a),e=c.data("button_class");c.removeClass("tdc-modal-open");"undefined"!==typeof e&&""!==e&&(c=f("."+e),c.length&&c.removeClass("tdc-window-open"))})},_sidebarModal:function(){f(".tdc-add-element").click(function(){f(this).toggleClass("tdc-window-open");
f(".tdc-sidebar-modal").each(function(b,a){var c=f(a),e=c.data("button_class");c.hasClass("tdc-sidebar-modal-elements")?(c.toggleClass("tdc-modal-open"),setTimeout(function(){var a=f(".tdc-sidebar-modal-search > input");a.focus();a.val("");f(".tdc-sidebar-element").each(function(a,c){f(c).show()})},100)):(c.removeClass("tdc-modal-open"),"undefined"!==typeof e&&""!==e&&(c=f("."+e),c.length&&c.removeClass("tdc-window-open")))})})},_bindElement:function(b){b.click(function(a){a.preventDefault()}).mousedown(function(a){if(1===
...
('<input class="tdc-css-border-radius" '+tdcSidebarPanel._getParamterDataAtts(g,l)+' name="" type="text" '+a(p)+' value="'+n+'"/>');h+='</div></div><div class="tdc-sidebar-horizontal-separator tdc-property-wrap tdc-property-horizontal_separator tdc-property-separator tdc-separator-small "></div>';n=tdcCssEditor._getSettingsProperty("width","",e());p="";k.isInherited&&(p=n,n="");h+='<div class="tdc-property-wrap tdc-width tdc-textfield-small'+c()+'" data-tdc-for="width">';h=h+'<div class="tdc-property-title"><span title="Css shadow-size">Width</span></div><div class="tdc-property">'+
