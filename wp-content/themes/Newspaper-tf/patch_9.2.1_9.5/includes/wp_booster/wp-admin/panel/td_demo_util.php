...
class td_demo_content extends td_demo_base {
    ...
    static private function parse_content_file($file_path)
    {
        ...
        $base64_encodable = false;

        if ( base64_decode( $file_content, true ) && base64_encode( base64_decode( $file_content, true ) ) === $file_content && mb_detect_encoding( base64_decode( $file_content, true ) ) === mb_detect_encoding( $file_content ) ) {
            $base64_encodable = true;
